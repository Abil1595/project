...
export default function UserList() {
    ...
    const setUsers = () => {
        const data = {
            columns: [
                ...
                { label: "Verified", field: "isVerified", sort: "asc" },
    ...
    // Wrapper to handle default values directly in parameters
    const CustomDataTable = ({
        ...
        return <MDBDataTable data={data} bordered={bordered} striped={striped} hover={hover} className={className} />;
    };;
